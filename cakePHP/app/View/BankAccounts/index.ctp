<div class="bankAccounts index">
	...
	<tr>
		<td><?php echo h($bankAccount['BankAccount']['account_number']); ?>&nbsp;</td>
		<td>
		...
		<td><?php echo h($bankAccount['BankAccount']['bank_address']); ?>&nbsp;</td>
		<td><?php echo h($bankAccount['BankAccount']['balance']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $bankAccount['BankAccount']['id']), array(), __('Are you sure you want to delete # %s?', $bankAccount['BankAccount']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
